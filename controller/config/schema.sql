...
CREATE TABLE
    IF NOT EXISTS plugin_installed (
...
CREATE TABLE
    IF NOT EXISTS connections (
        connectionName TEXT NOT NULL, -- The SQL namespace name
        databaseType TEXT NOT NULL, -- e.g. PostgreSQL, MySQL, OracleDB, etc.
        urn TEXT NOT NULL, -- The str to connect to the DB
        celScript TEXT DEFAULT 'true' NOT NULL, -- A CEL script to check if a table must be included
