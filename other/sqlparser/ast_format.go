...
// To generate ast_format_fast, install
// go install vitess.io/vitess/go/tools/astfmtgen
// go install golang.org/x/tools/cmd/goimports@latest
//
// and run
// astfmtgen github.com/julien040/anyquery/other/sqlparser/...
...
func (node *Select) Format(buf *TrackedBuffer) {
	...
	// Print from only if there is a from clause
	prefix := ""
	if len(node.From) > 0 {
...
func (node TableName) Format(buf *TrackedBuffer) {
	...
	// Print the table function parameters if they exist.
	if len(node.Args) > 0 {
