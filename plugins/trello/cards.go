			...
			Columns: []rpc.DatabaseSchemaColumn{
				{
					...
					Description: "The ID of the board. Needs to be specified in a SELECT statement in the WHERE clause",
				},
				{
					Name:        "list_id",
					Type:        rpc.ColumnTypeString,
					Description: "The ID of the list. Needs to be specified in an INSERT statement",
				},
				{
					Name:        "id",
					Type:        rpc.ColumnTypeString,
				...
				},
				{
					Name:        "url",
					Type:        rpc.ColumnTypeString,
					Description: "The URL of the card to view it in the browser",
				},
				{
					Name:        "start_at",
				...
				},
				{
					...
					Description: "Whether the card is due",
				},
				{
					Name:        "due_reminder",
					Type:        rpc.ColumnTypeDateTime,
					Description: "The date when the reminder is set",
				},
				{
					Name:        "comments_count",
					Type:        rpc.ColumnTypeInt,
					Description: "The number of comments on the card",
				},
				{
					Name:        "votes_count",
					Type:        rpc.ColumnTypeInt,
					Description: "The number of votes on the card",
				},
				{
					Name:        "checklists_count",
					Type:        rpc.ColumnTypeInt,
					Description: "The number of checklists on the card",
				},
				{
					Name:        "checked_items_count",
					Type:        rpc.ColumnTypeInt,
					Description: "The number of checked items on the card",
				},
				{
					Name:        "attachments_count",
					Type:        rpc.ColumnTypeInt,
					Description: "The number of attachments on the card",
				},
				{
					Name:        "labels",
					Type:        rpc.ColumnTypeString,
				...
				},
				{
					Name:        "location",
					Type:        rpc.ColumnTypeString,
					Description: "The location of the card",
				},
				{
					Name:        "member_ids",
					Type:        rpc.ColumnTypeString,
					Description: "A JSON array of member IDs",
				},
				{
					Name:        "label_ids",
					Type:        rpc.ColumnTypeString,
					Description: "A JSON array of label IDs",
				},
			},
		}, nil
}
