...
__release_files=(
    "https://github.com/asg017/sqlite-url/releases/download/v0.1.0/sqlite-url-v0.1.0-loadable-linux-x86_64.tar.gz"
    "https://github.com/asg017/sqlite-url/releases/download/v0.1.0/sqlite-url-v0.1.0-loadable-macos-x86_64.tar.gz")
__0_urls=("${__release_files[@]}")
__repo_name="asg017/sqlite-url"
__main_branch="main"
__readme_file="README.md"
__directories=("linux-amd64" "darwin-amd64")
