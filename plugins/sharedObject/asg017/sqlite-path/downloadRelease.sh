...
__release_files=(
    "https://github.com/asg017/sqlite-path/releases/download/v0.2.1/sqlite-path-v0.2.1-loadable-linux-x86_64.tar.gz"
    "https://github.com/asg017/sqlite-path/releases/download/v0.2.1/sqlite-path-v0.2.1-loadable-macos-aarch64.tar.gz"
    "https://github.com/asg017/sqlite-path/releases/download/v0.2.1/sqlite-path-v0.2.1-loadable-macos-x86_64.tar.gz"
    "https://github.com/asg017/sqlite-path/releases/download/v0.2.1/sqlite-path-v0.2.1-loadable-windows-x86_64.zip")
__0_urls=("${__release_files[@]}")
__repo_name="asg017/sqlite-path"
__main_branch="main"
