...
__release_files=(
    "https://github.com/asg017/sqlite-html/releases/download/v0.1.3/sqlite-html-v0.1.3-loadable-linux-x86_64.tar.gz"
    "https://github.com/asg017/sqlite-html/releases/download/v0.1.3/sqlite-html-v0.1.3-loadable-macos-aarch64.tar.gz"
    "https://github.com/asg017/sqlite-html/releases/download/v0.1.3/sqlite-html-v0.1.3-loadable-macos-x86_64.tar.gz"
    "https://github.com/asg017/sqlite-html/releases/download/v0.1.3/sqlite-html-v0.1.3-loadable-windows-x86_64.zip")
__0_urls=("${__release_files[@]}")
__repo_name="asg017/sqlite-html"
__main_branch="main"
