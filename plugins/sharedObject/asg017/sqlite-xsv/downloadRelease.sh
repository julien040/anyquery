...
__release_files=(
    "https://github.com/asg017/sqlite-xsv/releases/download/v0.2.1-alpha.11/sqlite-xsv-v0.2.1-alpha.11-loadable-linux-x86_64.tar.gz"
    "https://github.com/asg017/sqlite-xsv/releases/download/v0.2.1-alpha.11/sqlite-xsv-v0.2.1-alpha.11-loadable-macos-aarch64.tar.gz"
    "https://github.com/asg017/sqlite-xsv/releases/download/v0.2.1-alpha.11/sqlite-xsv-v0.2.1-alpha.11-loadable-macos-x86_64.tar.gz"
    "https://github.com/asg017/sqlite-xsv/releases/download/v0.2.1-alpha.11/sqlite-xsv-v0.2.1-alpha.11-loadable-windows-x86_64.zip"
)
__0_urls=("${__release_files[@]}")
__repo_name="asg017/sqlite-xsv"
__main_branch="main"
