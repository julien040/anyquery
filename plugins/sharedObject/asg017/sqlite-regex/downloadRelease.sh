...
__release_files=(
    "https://github.com/asg017/sqlite-regex/releases/download/v0.2.3/sqlite-regex-v0.2.3-loadable-linux-x86_64.tar.gz"
    "https://github.com/asg017/sqlite-regex/releases/download/v0.2.3/sqlite-regex-v0.2.3-loadable-macos-aarch64.tar.gz"
    "https://github.com/asg017/sqlite-regex/releases/download/v0.2.3/sqlite-regex-v0.2.3-loadable-macos-x86_64.tar.gz"
    "https://github.com/asg017/sqlite-regex/releases/download/v0.2.3/sqlite-regex-v0.2.3-loadable-windows-x86_64.zip"
)
__0_urls=("${__release_files[@]}")
__repo_name="asg017/sqlite-regex"
__main_branch="main"
